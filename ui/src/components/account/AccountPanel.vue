<template>
  <div class="modal-card w-424" :class="{ 'is-embedded': embedded }">
...
export default {
  name: "account-panel",
  props: {
    // When embedded inside Settings, this renders as a plain content
    // block (no modal-card header/shadow) - Settings already provides
    // the page title, and there's no floating overlay to escape from.
    embedded: {
      type: Boolean,
      default: false
    }
