...
<script>
import noticeBlock from "@/shared/noticBlock/noticeBlock";
...
.swiper-pagination {
	...
	::v-deep .swiper-pagination-bullet-active {
		// Sits over the desktop wallpaper (like the inactive dots above),
		// not a themed card surface - must stay a fixed light color in
		// both themes, not --theme-card-bg (which flips near-black in
		// dark mode and would make the "active" dot disappear).
		background: #ffffff;
	}
}
</style>
