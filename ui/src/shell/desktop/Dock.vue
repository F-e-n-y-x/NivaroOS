...
.dock {
	...
	/* left as-is: large decorative radius for the floating dock chrome; nearest token (--radius-modal, 14px) is 8px off and would visibly flatten the dock's shape */
	border-radius: 22px;
	z-index: 99990;
...
.dock-item-chosen {
	...
	.dock-icon {
		/* left as-is: combines a drop shadow with a colored focus ring, doesn't map to a single --shadow-* token */
