	...
	<div class="widget has-text-white clock is-relative">
		...
		<div class="network widget-content">
			...
			<div class="chart-container">
				<vue-apex-charts ref="chart" :options="chartOptions" :series="networks[networkId]" height="90"
					type="area" />
			</div>
			<!-- Chart End -->
			<!-- Status Start -->
...
export default {
	...
	gridCols: 5, // "wide" size - the traffic chart needs more horizontal room; same height as a normal widget (see SideBar.vue)
	gridRows: 2,
	initShow: true,
	components: {
...
.network {
	...
	.chart-container {
		// Matches the <vue-apex-charts height="90"> prop below - this was
		// left at the old 130px when the chart itself was shrunk to fix
		// the widget's overall height, leaving a ~40px dead gap between
		// the chart and the up/down speed row.
		height: 90px;
		overflow: hidden;
		margin: 0 -0.875rem;
	}
