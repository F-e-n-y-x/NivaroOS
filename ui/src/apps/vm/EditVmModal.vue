...
.iso-picker {
	...
	width: 100%;
	max-width: 18rem;
	border: 1px solid var(--theme-card-border, rgb(228 233 237)); border-radius: var(--radius-control); background: var(--theme-input-bg, #fff); color: var(--theme-text-primary, inherit); padding: var(--space-2) var(--space-3);
	font-family: inherit;
	font-size: var(--font-sm);
...
.iso-picker-chevron {
	flex-shrink: 0;
	color: var(--theme-text-muted, rgba(0, 0, 0, 0.3));
}
...
.slider-value-input {
	...
	background: var(--theme-card-hover, rgba(0, 0, 0, 0.045));
	color: var(--theme-text-primary, rgba(44, 62, 80, 0.85));
	font-family: inherit;
...
.vm-share-row {
	...
	border: 1px solid var(--theme-card-border, rgb(228 233 237)); border-radius: var(--radius-card); background: var(--theme-card-bg, #fff); color: var(--theme-text-primary, inherit);
}
