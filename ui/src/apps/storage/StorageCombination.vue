<template>
	<div v-show="showCombination" class="mb-5 mt-2 pt-5 pb-5 border-1 combination-box">
		<div class="is-relative is-flex is-justify-content-center top--2rem">
			<div class="pr-4 pl-4 has-background-white">NivaroOS HD</div>
		</div>
		<div class="is-flex ">
...
.combination-box {
	background-color: var(--theme-bg-subtle, hsla(208, 16%, 98%, 1));
	border: 1px solid var(--theme-card-border, hsla(208, 16%, 91%, 1));
	...
	.tag {
		background-color: var(--color-primary-soft, hsla(208, 16%, 98%, 1));
		border: 1px solid var(--color-primary, hsla(208, 100%, 45%, 1));
		color: var(--color-primary, hsla(208, 100%, 45%, 1));
