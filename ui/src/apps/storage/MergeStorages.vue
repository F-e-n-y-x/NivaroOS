...
.pri-head {
	...
	border-bottom: 1px solid var(--theme-card-border, rgba(0, 0, 0, 0.1)) !important;
}
...
.pri-mrl-2rem {
	...
	div:hover {
		background: var(--color-primary-soft, hsla(215, 89%, 93%, 1));
	}
}
...
._has-text-gray-800 {
	...
	color: var(--theme-text-primary, hsla(208, 20%, 20%, 1));
}

._has-text-gray-600 {
	/* Gary/600 */
	color: var(--theme-text-secondary, hsla(208, 14%, 58%, 1));
}
...
._has-background-gray-100 {
	/* Gray/100 */
	background: var(--theme-bg-subtle, hsla(208, 16%, 96%, 1));
}
...
.pri-text-color {
	color: var(--theme-text-muted, hsla(0, 0%, 0%, 0.4));
}
...
.message-alert {
	...
	margin-right: var(--space-8);
	border-radius: var(--radius-xs);
	color: var(--color-warning, hsla(40, 100%, 43%, 1));
	font-size: var(--font-base);
	font-style: normal;
	background: var(--theme-warning-soft, hsla(40, 100%, 95%, 1));
}
...
.pri-message-danger {
	...
	margin-right: var(--space-8);
	border-radius: var(--radius-xs);
	color: var(--color-danger, hsla(348, 86%, 61%, 1));
	font-size: var(--font-base);
	font-style: normal;
	background: var(--theme-danger-soft, hsla(348, 100%, 95%, 1));
}

.t-line {
	border-top: 1px solid var(--theme-card-border, rgba(0, 0, 0, 0.1)) !important;
}
