				...
				<template v-if="!isLoadError">
							...
							<swiper ref="featureSwiper" :options="featureSwiperOptions" class="swiper">
								...
								>
									<div class="gap" @click="showAppDetial(item.id)">
										<b-image
											:placeholder="require('@/assets/img/app-icons/swiper_placeholder.png')"
											:src="item.thumbnail"
											:src-fallback="require('@/assets/img/app-icons/swiper_placeholder.png')"
									...
									<div class="is-flex pt-5 is-align-items-center">
										<div class="mr-3" @click="showAppDetial(item.id)">
											<b-image
												:placeholder="require('@/assets/img/app-icons/default.svg')"
												:src="item.icon"
					...
					<template v-if="communityList.length > 0">
						...
						<h3 class="subtitle is-7 has-text-grey-light">
							{{
								$t(
									'From community contributors, not optimized for NivaroOS, but provides a basic App experience.'
								)
							}}
						</h3>
...
import AppsInstallationLocation from '@/apps/app-store/AppsInstallationLocation'
import business_ShowNewAppTag from '@/mixins/app/Business_ShowNewAppTag'
import business_OpenThirdApp from '@/mixins/app/Business_OpenThirdApp'
import ComposeConfig from '@/apps/app-store/ComposeConfig.vue'
import AppDetailInfo from '@/apps/app-store/AppDetailInfo.vue'
