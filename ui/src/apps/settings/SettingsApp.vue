...
<script>
import SettingsNav from '@/apps/settings/SettingsNav.vue'
import SettingsSearch from '@/apps/settings/SettingsSearch.vue'
import AppearanceSection, { ROWS as APPEARANCE_ROWS } from '@/apps/settings/sections/AppearanceSection.vue'
import UsersSection, { ROWS as USERS_ROWS } from '@/apps/settings/sections/UsersSection.vue'
import NetworkSection, { ROWS as NETWORK_ROWS } from '@/apps/settings/sections/NetworkSection.vue'
import StorageSection, { ROWS as STORAGE_ROWS } from '@/apps/settings/sections/StorageSection.vue'
import OnlineAccountsSection, { ROWS as CLOUD_ROWS } from '@/apps/settings/sections/OnlineAccountsSection.vue'
import SystemSection, { ROWS as SYSTEM_ROWS } from '@/apps/settings/sections/SystemSection.vue'
import UpdatesSection, { ROWS as UPDATES_ROWS } from '@/apps/settings/sections/UpdatesSection.vue'
import PackagesSection, { ROWS as PACKAGES_ROWS } from '@/apps/settings/sections/PackagesSection.vue'
