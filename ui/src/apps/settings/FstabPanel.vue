...
.icon-button {
	...
	cursor: pointer;
	color: var(--theme-text-muted, rgba(44, 62, 80, 0.65));
...
.mount-card {
	...
	&:hover {
		border-color: var(--color-primary, rgba(50, 115, 220, 0.3));
		box-shadow: var(--shadow-md);
	}

	&.is-unmounted {
		border-style: dashed;
		background: var(--theme-card-subtle, rgba(255, 255, 255, 0.7));
	}

	&.is-missing {
		border-style: dashed;
		border-color: var(--color-danger, rgba(239, 68, 68, 0.35));
		background: var(--theme-danger-soft, rgba(239, 68, 68, 0.03));
	}
}
...
.fs-badge {
	...
	background: var(--theme-pill-bg, rgba(0, 0, 0, 0.06));
	color: var(--theme-pill-color, rgba(30, 41, 59, 0.8));
	letter-spacing: 0.02em;
}

.drive-source-meta {
	font-size: var(--font-2xs);
	color: var(--theme-text-muted, rgba(100, 116, 139, 0.8));
	display: flex;
	align-items: center;
	margin-top: var(--space-1);
}
...
.status-pill {
	...
	&.is-unmounted {
		background: var(--theme-card-hover, rgba(100, 116, 139, 0.1));
...
.status-dot {
	...
	&.is-good {
		background: var(--color-success, #23d160);
	}
...
.mount-target-box {
	...
	align-items: center;
	gap: var(--space-2);
	background: var(--theme-card-subtle, rgba(241, 245, 249, 0.8));
	...
	&:hover {
		background: var(--theme-card-hover, rgba(226, 232, 240, 0.9));
...
.mount-card-footer {
	...
	align-items: center;
	justify-content: space-between;
	border-top: 1px solid var(--theme-table-divider, rgba(0, 0, 0, 0.05));
...
.system-entries-toggle {
	...
	border: none;
	background: none;
	color: var(--theme-text-secondary, rgba(71, 85, 105, 0.85));
...
.system-row {
	...
	background: var(--theme-card-subtle, rgba(248, 250, 252, 0.8));
	border-radius: var(--radius-control);
	font-size: var(--font-xs);
}
...
.protected-pill {
	font-size: var(--font-2xs);
	font-weight: 600;
	background: var(--theme-pill-bg, rgba(100, 116, 139, 0.12));
...
.in-window-modal-backdrop {
	...
	right: 0;
	bottom: 0;
	background: var(--theme-modal-overlay, rgba(15, 23, 42, 0.45));
...
.candidate-card {
	...
	&:hover {
		...
		background: var(--color-primary-soft, rgba(50, 115, 220, 0.03));
	}
...
.empty-candidate-box {
	background: var(--theme-card-subtle, rgba(241, 245, 249, 0.6));
	border-radius: var(--radius-control);
	padding: var(--space-3);
	text-align: center;
}
...
.preset-card {
	...
	&:hover {
		border-color: var(--color-primary);
		background: var(--color-primary-soft, rgba(50, 115, 220, 0.02));
	}
