...
func InitV1Router() http.Handler {
	...
	}))
	{
		...
		v1SysGroup.Use()
		{
			...
			v1SysGroup.GET("/apt/remove-preview", v1.GetAptRemovePreview)
			...
			v1SysGroup.DELETE("/system-users/:username", v1.DeleteSystemUser)
			v1SysGroup.PUT("/system-users/:username/password", v1.PutSystemUserPassword)
			v1SysGroup.PUT("/system-users/:username/groups", v1.PutSystemUserGroups)

			v1SysGroup.GET("/smb-users", v1.GetSmbUsers)
			v1SysGroup.POST("/smb-users", v1.PostSmbUser)
			v1SysGroup.DELETE("/smb-users/:username", v1.DeleteSmbUser)
		...
		v1BatchGroup.Use()
		{
			...
			v1BatchGroup.POST("/download", v1.PostDownloadTicket)
		}
