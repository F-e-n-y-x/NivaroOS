...
//go:generate bash -c "mkdir -p codegen/message_bus && go run github.com/deepmap/oapi-codegen/cmd/oapi-codegen@v1.12.4 -package message_bus ../message-bus/api/message_bus/openapi.yaml > codegen/message_bus/api.go"
package main
...
import (
	...
	"github.com/F-e-n-y-x/recasa/services/user/common"
	"github.com/F-e-n-y-x/recasa/services/user/pkg/config"
	"github.com/F-e-n-y-x/recasa/services/user/pkg/sqlite"
	"github.com/F-e-n-y-x/recasa/services/user/pkg/utils/encryption"
	"github.com/F-e-n-y-x/recasa/services/user/pkg/utils/random"
	"github.com/F-e-n-y-x/recasa/services/user/route"
